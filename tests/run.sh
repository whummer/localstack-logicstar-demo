...
curl -X GET "$API_ENDPOINT/getquiz?quiz_id=8d641539-9608-4d19-95f1-861e91dc9f4b"
...
-d '{
    "Username": "user1",
    "QuizID": "8d641539-9608-4d19-95f1-861e91dc9f4b",
    "Answers": {
        "0": "D. Paris",
        "1": "B. Shakespeare"
    }
...
curl -X GET "$API_ENDPOINT/getleaderboard?quiz_id=8d641539-9608-4d19-95f1-861e91dc9f4b&top=3"
